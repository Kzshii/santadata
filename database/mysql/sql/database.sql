...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `full_patient` (`idpeople` INT, `iduser` INT, `nr_prontuario` INT, `nr_mv` INT, `name` INT, `cpf` INT, `picture` INT, `dtnasc` INT, `etiny` INT, `tel1` INT, `tel2` INT, `tel_emerg` INT, `cel` INT, `address` INT);
...
SELECT pa.idpeople, pa.iduser,pa.prontuary_number as nr_prontuario, pa.mv_number as nr_mv,
 pe.name, pe.cpf, pe.picture, pe.dtnasc, pe.etiny, pe.tel1, pe.tel2, pe.tel_emerg, pe.cel, pe.cel, pe.address 
 FROM  patient as pa 
