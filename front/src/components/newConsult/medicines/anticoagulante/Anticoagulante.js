...
class Anticoagulante extends Component {
						...
						<label htmlFor="anticoagulante">Anticoagulante</label>
						{
							this.props.form.map(
								(row) => {
									return(
										<div key={ row.id }>
											<input type="radio" name="anticoagulante" value={ row.id } onChange={ this.handleChange }/>
