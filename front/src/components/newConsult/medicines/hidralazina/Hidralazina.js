...
class Hidralazina extends Component {
						...
						<label htmlFor="hidralazina">Hidralazina</label>
						{
							this.props.form.map(
								(row) => {
									return(
										<div key={ row.id }>
											<input type="radio" name="hidralazina" value={ row.id } onChange={ this.handleChange }/>
