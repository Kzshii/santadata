...
class SarcubitrilValsartana extends Component {
	...
	render(){
		...
		if(this.props.form) {
			return(
				<div className="sarcubitril_valsartana">
					<form onSubmit={this.handleSubmit}>

						<label htmlFor="sarcubitrilvalsartana">SarcubitrilValsartana</label>
						{
							this.props.form.select.map(
								(row) => {
									return(
										<div key={ row.id }>
											<input type="radio" name="sarcubitril_valsartana" value={ row.id } onChange={ this.handleChange }/>
...
export default SarcubitrilValsartana;
